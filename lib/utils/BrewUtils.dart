...
class BrewUtils {
  ...
  static Future<double> calcHeatingTimeInSecondsAsync(double batchSize, double plato) async {
    return await Future.value(calcHeatingTimeInSeconds(batchSize, plato));
  }
